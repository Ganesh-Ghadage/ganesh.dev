...
export const StickyScroll = ({
  ...
  return (
    <motion.div
      ...
      className="h-[30rem] overflow-y-auto scrollbar-hidden flex justify-center relative space-x-10 rounded-md p-10"
      ref={ref}
    >
          ...
          {content.map((item, index) => (
            <div key={item.title + index} className="my-20">
              ...
              <motion.p
                ...
                className="text-kg dark:text-slate-300 text-slate-700 max-w-sm mt-10"
              >
                {item.description}
              </motion.p>
            </div>
      ...
      <div
        ...
        className={cn(
          "hidden lg:block h-60 w-80 rounded-md dark:bg-white bg-black sticky top-10 overflow-hidden",
          contentClassName
        )}
      >
